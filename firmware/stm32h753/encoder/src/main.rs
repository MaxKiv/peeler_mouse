...
async fn main(spawner: Spawner) {
    ...
    let knife_step_pwm_pin = p.PB15;
    let knife_step_pwm = PwmPin::new(knife_step_pwm_pin, OutputType::PushPull);
    let knife_step_timer = p.TIM12;
    let knife_pwm = SimplePwm::new(
        ...
        None,
        None,
        hz(l9110::DEFAULT_PWM_FREQUENCY.0),
        Default::default(),
    );
    ...
    Output::new(p.PE4, Level::Low, Speed::VeryHigh);
